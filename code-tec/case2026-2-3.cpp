...
int main(int argc, char **argv) {
  ...
  if (rank == 0) {
    ...
    MPI_Scatterv(nullptr, nullptr, nullptr, MPI_INT, localA.data(), my_rows * n,
  ...
  if (rank == 0) {
    ...
    MPI_Gatherv(localC.data(), my_rows * n, MPI_INT, globalC.data(),
    ...
    MPI_Gatherv(localC.data(), my_rows * n, MPI_INT, nullptr, nullptr, nullptr,
                MPI_INT, 0, MPI_COMM_WORLD);
  }
